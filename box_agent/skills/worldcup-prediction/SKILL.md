...
真实 2026 世界杯为 **48 队 / 12 组**(美·加·墨主办,小组赛多为中性场)。本库**聚焦
25 支球队**——涵盖当前比赛日(`schedule.yaml`)能跑通的全部对阵 + 主要争冠球队。
每队一个 YAML:`references/teams/<name>.yaml`。代码与真实分组:

| 代码 | 球队 | 组 | 代码 | 球队 | 组 | 代码 | 球队 | 组 |
|------|------|----|------|------|----|------|------|----|
| MEX | 墨西哥 | A | BRA | 巴西 | C | USA | 美国 | D |
| GER | 德国 | E | NED | 荷兰 | F | JPN | 日本 | F |
| BEL | 比利时 | G | ESP | 西班牙 | H | URU | 乌拉圭 | H |
| FRA | 法国 | I | SEN | 塞内加尔 | I | NOR | 挪威 | I |
| IRQ | 伊拉克 | I | ARG | 阿根廷 | J | ALG | 阿尔及利亚 | J |
| AUT | 奥地利 | J | JOR | 约旦 | J | POR | 葡萄牙 | K |
| COL | 哥伦比亚 | K | COD | 刚果(金) | K | UZB | 乌兹别克 | K |
| ENG | 英格兰 | L | CRO | 克罗地亚 | L | GHA | 加纳 | L |
| PAN | 巴拿马 | L |

库外球队(48 强其余 23 队)暂无数据;遇到时脚本对该场标「缺数据」,需先按相同格式
扩充 `references/teams/` 才能预测。**评分(ratings 0-100)与球员属性为主观估计,非官方数据。**
